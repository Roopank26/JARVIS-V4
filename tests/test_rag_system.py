...
from jarvis.rag.document_processor import DocumentProcessor, DocumentChunk, ProcessedDocument, StudyAssistant
...
class TestDocumentProcessor:
    ...
    def temp_txt_file(self):
        ...
        tmp.write("This is a test document. It contains some sample text for testing purposes. Machine learning is a subset of artificial intelligence. Deep learning uses neural networks with many layers.")
        tmp.close()
        yield Path(tmp.name)
