...
class SecurityScanner:
    ...
    PATTERNS = [
        ...
        (r'yaml\s*\.(load|safe_load)\s*\([^)]*\)\s*(?!.*Loader=yaml\.SafeLoader)',
         "Unsafe YAML Deserialization", "medium",
    ...
    FILE_PATTERNS = [
        ...
        ("*.sqlite", "SQLite database", "medium", "Database files should not be in source control."),
    ...
    def scan_file(self, file_path: str, content: Optional[str] = None) -> List[SecurityIssue]:
