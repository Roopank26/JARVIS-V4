...
class EnhancedMemoryManager:
    ...
    def is_profile_query(self, text: str) -> bool:
        ...
        for pattern in question_patterns:
            if re.search(pattern, text_lower) and "?" in text:
                return True
    ...
    def handle_profile_command(self, text: str) -> Optional[str]:
        """
        ...
        if re.search(r"(?:my\s+)?profile", text_lower) or \
           re.search(r"summarize", text_lower):
            return self.get_profile_summary()
...
# Global instance
_enhanced_memory: Optional[EnhancedMemoryManager] = None
