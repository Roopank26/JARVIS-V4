...
class Logger:
    ...
    def debug(self, msg: str): self.logger.debug(self._colorize('DEBUG', msg))
    def info(self, msg: str): self.logger.info(self._colorize('INFO', msg))
    def warning(self, msg: str): self.logger.warning(self._colorize('WARNING', msg))
    def error(self, msg: str): self.logger.error(self._colorize('ERROR', msg))
    def critical(self, msg: str): self.logger.critical(self._colorize('CRITICAL', msg))


class Timer:
    """Context manager for timing operations."""
    
    def __init__(self, name: str = "Operation", callback: Optional[Callable] = None):
        self.name = name
