"""
JARVIS Phase 3 — Security & Privacy Layer.

Provides:
- Encrypted local memory and credentials
- Permission-based tool access
- Secure plugin sandboxing concepts
...
class PermissionChecker:
    ...
    def can(self, actor: str, tool: str) -> bool:
        allowed = self._allowed_tools.get(actor, [])
        return tool in allowed if allowed else not self._default_deny
